...
<img src="../images/alerts/deadlock1.png" width="1000" alt="Deadlock1">
...
6. If needed, use the "Recalculate Level" [Recovery Action](../main-screens/administration/recovery-actions.md).


**Navigation:** [← Common Issues](common-issues.md) | [Case Replacement →](case-replacement.md)