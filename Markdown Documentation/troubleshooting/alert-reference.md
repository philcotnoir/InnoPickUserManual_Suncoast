...
2. Check Galil controller for error code using:
    ...
    - MG _ED0 (The line number of the last error)
    - MG _ED1 (The thread where the error occurred)
...
5. **Monitor closely** for several cycles
